...
import org.corpus_tools.pepperModules_HeadMarkerModule.HeadMarkerModuleManipulator;
 ...
 * {@link HeadMarkerModuleManipulator} class. Feel free to adapt and enhance this test
 ...
 * @author Amir_Zeldes
 */
public class HeadMarkerModuleManipulatorTest extends PepperManipulatorTest {
	/**
	...
	@Before
	public void setUp() {
		setFixture(new HeadMarkerModuleManipulator());
	}
